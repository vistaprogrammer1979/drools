...
public class WorkflowOutcome implements Serializable {
    ...
    public WorkflowOutcome(Integer id) {
        this.id = id;
    }

    public WorkflowOutcome(String severity, String ruleName, String shortMsg, String longMsg) {
...
//        if (!(object instanceof WorkflowOutcome)) {
//            return false;
//        }
//        WorkflowOutcome other = (WorkflowOutcome) object;
