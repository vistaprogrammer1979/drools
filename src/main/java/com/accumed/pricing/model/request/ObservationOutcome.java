...
public class ObservationOutcome implements Serializable {
    ...
    @JoinColumn(name = "observation", referencedColumnName = "ID")
    @ManyToOne
    @XmlTransient
    ...
    public ObservationOutcome(Integer id) {
        this.id = id;
    }
    
    public ObservationOutcome(String severity, String ruleName, String shortMsg, String longMsg) {
...
//        if (!(object instanceof ObservationOutcome)) {
//            return false;
//        }
//        ObservationOutcome other = (ObservationOutcome) object;
