...
//    public RequestOutcome(Exception e) {
//        ruleName = "Internal Exception";
//        if (e != null) {
//            shortMsg = e.getMessage();
//            if(shortMsg == null) shortMsg = e.getClass().getName();
//            if (e.getCause() != null) {
//                if (shortMsg == null) {
//                    shortMsg = e.getCause().toString();
//                }
//                longMsg = e.getCause().toString();
//                Throwable t = null;
...
//        if (!(object instanceof RequestOutcome)) {
//            return false;
//        }
//        RequestOutcome other = (RequestOutcome) object;
