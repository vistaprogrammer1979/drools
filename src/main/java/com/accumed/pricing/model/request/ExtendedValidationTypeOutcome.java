...
@Entity
@Table(name = "ExtendedValidationTypeOutcome")
@NamedQueries({
...
public class ExtendedValidationTypeOutcome implements Serializable {
    ...
    @JoinColumn(name = "extendedValidationType", referencedColumnName = "ID")
    @ManyToOne
    @XmlTransient
    private ExtendedValidationType extendedValidationType;

    public ExtendedValidationTypeOutcome() {
    }

    public ExtendedValidationTypeOutcome(Integer id) {
        this.id = id;
    }
    
    public ExtendedValidationTypeOutcome(String severity, String ruleName, String shortMsg, String longMsg) {
    ...
    public ExtendedValidationType getExtendedValidationType() {
        return extendedValidationType;
    }

    public void setExtendedValidationType(ExtendedValidationType extendedValidationType) {
...
//        if (!(object instanceof ExtendedValidationTypeOutcome)) {
//            return false;
//        }
//        ExtendedValidationTypeOutcome other = (ExtendedValidationTypeOutcome) object;
