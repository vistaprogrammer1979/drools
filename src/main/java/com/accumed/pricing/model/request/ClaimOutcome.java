...
public class ClaimOutcome implements Serializable {
    ...
    public ClaimOutcome(Integer id) {
        this.id = id;
    }

    public ClaimOutcome(String severity, String ruleName, String shortMsg, String longMsg) {
...
//        if (!(object instanceof ClaimOutcome)) {
//            return false;
//        }
//        ClaimOutcome other = (ClaimOutcome) object;
