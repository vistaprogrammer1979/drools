...
public class HeaderOutcome implements Serializable {
    ...
    public HeaderOutcome() {
    }

    public HeaderOutcome(Integer id) {
        this.id = id;
    }
    
    public HeaderOutcome(String ruleName, String severity, String shortMsg, String longMsg) {
...
//        if (!(object instanceof HeaderOutcome)) {
//            return false;
//        }
//        HeaderOutcome other = (HeaderOutcome) object;
