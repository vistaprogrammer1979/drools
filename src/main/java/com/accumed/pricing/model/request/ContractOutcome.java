...
public class ContractOutcome implements Serializable {
    ...
    public ContractOutcome(Integer id) {
        this.id = id;
    }
    
    public ContractOutcome(String severity, String ruleName, String shortMsg, String longMsg) {
...
//        if (!(object instanceof ContractOutcome)) {
//            return false;
//        }
//        ContractOutcome other = (ContractOutcome) object;
