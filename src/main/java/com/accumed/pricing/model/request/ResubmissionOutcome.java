...
@Entity
@Table(name = "ResubmissionOutcome")
...
public class ResubmissionOutcome implements Serializable {
    ...
    @JoinColumn(name = "resubmission", referencedColumnName = "ID")
    @ManyToOne
    @XmlTransient
    private Resubmission resubmission;

    public ResubmissionOutcome() {
    }

    public ResubmissionOutcome(Integer id) {
        this.id = id;
    }
    
    public ResubmissionOutcome(String severity, String ruleName, String shortMsg, String longMsg) {
...
//        if (!(object instanceof ResubmissionOutcome)) {
//            return false;
//        }
//        ResubmissionOutcome other = (ResubmissionOutcome) object;
